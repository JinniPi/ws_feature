...
if __name__ == "__main__":
	...
	vocab = Helper().loadfile_data_json("vocab_vlsp_lower.json")
	print(len(vocab))
	vocab_feature_basic = dic.gen_feature_basic_e(vocab)
	Helper.write_json(vocab_feature_basic[0], "feature_basic_B_lower.json")
	Helper.write_json(vocab_feature_basic[1], "feature_basic_I_lower.json")

	vocab_feature_enhance = dic.add_enhance_to_feature_e(vocab_feature_basic, path_stop_word)
	Helper.write_json(vocab_feature_enhance[0], "feature_enhance_B_lower.json")
	Helper.write_json(vocab_feature_enhance[1], "feature_enhance_I_lower.json")
