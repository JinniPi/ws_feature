...
class Dictionary:
    ...
    def add_enhance_to_feature_e(self, vocab_feature_basic, stop_word_path):
        ...
        for vocab_feature_basic_state in vocab_feature_basic:
            ...
            for syllable in vocab_feature_basic_state:
                enhance_feature = self.gen_enhance_feature_e(syllable, list_stop_word, 2*len_vocab)
    ...
    def covert_feature_to_array(self, vocab_feature, dim):
        """
        ...
        # if independent:
        #     if basic:
        #         dim = len(vocab_feature[0])
        #     else:
        #         dim = len(vocab_feature[0]) + 7
        # else:
        #     if basic:
        #         dim = 2*len(vocab_feature[0])
        #     else:
        #         dim = 2*len(vocab_feature[0]) + 7
        array_feature = []
